...
#### 插件(luci-app)：
```
-luci-app-gpsysupgrade -luci-app-upnp -luci-app-advanced -luci-app-wizard luci-app-hd-idle luci-app-unishare luci-app-filebrowser luci-app-sunpanel luci-app-alist luci-app-store
```
#### 初始化(Shell):
```
#!/bin/bash
...
config mount
	...
	option uuid '382c741d-fa5c-46b3-ab05-0b8d3e6f02bb'
	option enabled '1'
EOF
